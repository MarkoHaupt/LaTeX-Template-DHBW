...
\newcommand{\varCompany}{!!!Unternehmen!!!}
\newcommand{\varDepartment}{!!!Abteilung!!!}
\newcommand{\varCourse}{!!!Kurs!!!}
\newcommand{\varCourseDirector}{!!!Kursleiter!!!}
\newcommand{\varScientificAdvisor}{!!!Wissenscahftlicher Betreuer!!!}
\newcommand{\varScientificAdvisorMail}{!!!E-Mail von Wissenschaflichem Betreuer!!!}
\newcommand{\varScientificAdvisorNumber}{!!!Nummer von Wissenschaflichem Betreuer!!!}
\newcommand{\varCompanySupervisor}{!!!Firmenbetreuer!!!}
\newcommand{\varCompanySupervisorMail}{!!!E-Mail von Firmenbetreuer!!!}
